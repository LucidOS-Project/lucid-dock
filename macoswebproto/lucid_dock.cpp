...
//
// The hold was four seconds first, then 2.75, and is 3 -- four felt long, and
// settling it by feel is the right way, because the label has been read inside
// the first second and everything after that is it sitting on the desktop
// having already done its job. There is no correct value here and no
// measurement that would produce one; these are the two numbers to change if
// it ever feels wrong again.
constexpr double TOOLTIP_HOLD = 3.0;    // seconds at full opacity
